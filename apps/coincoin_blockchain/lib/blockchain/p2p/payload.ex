defmodule Coincoin.Blockchain.P2P.Payload do
  @moduledoc "Data going throught to the P2P protocol"

  alias Coincoin.Blockchain.{Block, P2P.Payload}
  ...
  @type t :: %Payload{
          type: String.t(),
          blocks: [Block.t()] | nil,
          data: Coincoin.Blockchain.BlockData.t() | nil
        }
  ...
  @spec mining_request(Coincoin.Blockchain.BlockData.t()) :: t
