...
defmodule Coincoin.Blockchain.P2P.Server do
  @moduledoc "TCP server to handle communications between peers"

  alias Coincoin.Blockchain.P2P.{Peers, Command}
  ...
  def handle_socket(socket) do
    ...
    {:ok, pid} =
      Task.Supervisor.start_child(Coincoin.Blockchain.P2P.Server.TasksSupervisor, fn ->
        serve(socket)
      end)
