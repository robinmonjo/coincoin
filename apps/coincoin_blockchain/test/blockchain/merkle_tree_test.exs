defmodule Coincoin.Blockchain.Test.MerkleTreeTest do
  use ExUnit.Case, async: true

  alias Coincoin.Blockchain.MerkleTree
  ...
  test "build a tree and access its root", %{leaves: leaves} do
    # this works because BitString implements Coincoin.Blockchain.BlockData
